...
import static com.zougn.blog.enums.CommentTypeEnum.getCommentEnum;
import static com.zougn.blog.enums.CommentTypeEnum.getCommentPath;
...
public class CommentServiceImpl extends ServiceImpl<CommentDao, Comment> implements CommentService {
    ...
    public CommentServiceImpl(@Value("${website.url}") String websiteUrl, CommentDao commentDao, ArticleDao articleDao, TalkDao talkDao, RedisService redisService, UserInfoDao userInfoDao, RabbitTemplate rabbitTemplate, BlogInfoService blogInfoService) {
    ...
    public void updateCommentsReview(ReviewVO reviewVO) {
        ...
        List<Comment> commentList = reviewVO.getIdList().stream().map(item -> Comment.builder()
                        ...
                        .build())
                .collect(Collectors.toList());
        CommentServiceImpl commentService = (CommentServiceImpl) AopContext.currentProxy();
