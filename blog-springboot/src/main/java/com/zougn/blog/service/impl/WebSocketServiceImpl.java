...
import com.zougn.blog.dao.ChatRecordDao;
import com.zougn.blog.dto.ChatRecordDTO;
import com.zougn.blog.dto.RecallMessageDTO;
import com.zougn.blog.dto.WebsocketMessageDTO;
import com.zougn.blog.entity.ChatRecord;
import com.zougn.blog.enums.FilePathEnum;
import com.zougn.blog.strategy.context.UploadStrategyContext;
import com.zougn.blog.util.BeanCopyUtils;
import com.zougn.blog.util.HTMLUtils;
import com.zougn.blog.util.IpUtils;
import com.zougn.blog.vo.VoiceVO;
import lombok.Data;
...
import static com.zougn.blog.enums.ChatTypeEnum.*;
...
public class WebSocketServiceImpl {
     ...
     */
    @OnOpen
    public synchronized void onOpen(Session session, EndpointConfig endpointConfig) throws IOException {
        // 加入连接
